...
$current_name   = $_SESSION['emp_name'] ?? 'Inventory Staff';
$current_no     = $_SESSION['emp_no'] ?? 'INV-STAFF';
$current_role   = $_SESSION['emp_role'] ?? 'Inventory Specialist';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="sidebar">
    ...
    <div class="sidebar-footer">
        ...
        <a href="inv_logout.php" class="btn btn-sm btn-outline-light w-100 logout-link">
...
function changeTitle(page){
    $("#pageTitle").text(pageTitles[page] || 'Inventory Portal');
}
