...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2026 at 05:59 PM
...
(1, 'July 1 - 15', '2026-07-01', '2026-07-15', '2026-07-15', 'Paid', 1, '2026-07-09 17:24:20'),
(2, 'july 15 - 30', '2026-07-15', '2026-07-30', '2026-07-30', 'Paid', 1, '2026-07-09 17:46:17');
...
(1, 'admin1234@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin User', 'Admin', 'Active', '2026-06-25 16:46:12', '2026-07-09 20:11:01'),
...
--
ALTER TABLE `positions`
  ADD CONSTRAINT `fk_position_dept` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`);
