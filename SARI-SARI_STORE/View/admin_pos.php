...
<div class="sidebar">
    ...
    <div class="cashier-info">
        ...
        <div>
            ...
            <div class="cashier-role">Admin</div>
        </div>
    </div>
...
<div class="main">
    ...
    <div id="content">
        <?php
        $targetPage = $_GET['page'] ?? 'cashier_pos.php';
...
/*====================================================
    PAGE TITLE
====================================================*/
const currentPosPage = '<?= $_GET['page'] ?? 'cashier_pos.php'; ?>';
switch(currentPosPage){
...
function loadPage(page, element = null){
    window.location.href = 'admin_pos.php?page=' + encodeURIComponent(page);
}
