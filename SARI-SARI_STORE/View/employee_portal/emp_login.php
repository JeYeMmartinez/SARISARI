...
<div class="login-wrapper animate__animated animate__fadeIn">
    ...
    <div class="login-left">
        ...
        <h1>Employee Portal<br>HRMS self-service</h1>
        <p>Access your profile details, check attendance logs, view payslips, and request leave or file resignation online.</p>
        ...
        <form method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="form-text" style="font-size: 11px;">
                    <i class="bi bi-info-circle me-1"></i>Default password is your Employee ID (e.g., EMP-0001)
                </div>
            </div>
