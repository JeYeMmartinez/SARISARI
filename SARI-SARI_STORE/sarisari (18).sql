...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2026 at 08:24 PM
...
CREATE TABLE `applicants` (
  ...
  `next_interview` datetime DEFAULT NULL,
...
INSERT INTO `applicants` (`applicant_id`, `position_id`, `full_name`, `email`, `phone`, `address`, `resume`, `stage`, `next_interview`, `notes`, `schedule`, `rest_day`, `applied_at`, `updated_at`) VALUES
(11, 6, 'Argentina Corn Beef', 'Johnmmartinez814@gmail.com', '09343141341', 'BLK 1 LOT 28', '1783869615_MABKOM_20260711_162914_0000.pdf', 'Approved', NULL, 'dqdqd', NULL, NULL, '2026-07-12 15:20:15', '2026-07-12 23:20:29'),
(12, 6, 'Lucky Me Noodles', 'jmarkmartinez14@gmail.com', '09123123123', 'BLK 1 LOT 28', '1783879356_LCS_Reviewer_20260711_175344_0000.pdf', 'Approved', NULL, 'dqdqwdqwd', NULL, NULL, '2026-07-12 18:02:36', '2026-07-13 02:04:43');
...
(3, 10, 6, 'jushiramen', 'sushiramenthis1@gmail.com', '09123123123', 'BLK 1 LOT 28', '1783853220_LCS_Reviewer_20260711_175344_0000.pdf', 'Approved', 'qfqwfq', '2026-07-12 10:47:00', 'Hired', 1, '2026-07-12 11:21:15');
...
(2, 7, '2026-07-12', '08:10:00', '21:11:00', 13.02, 5.02, 'Present', 'grddgd', '2026-07-12 15:11:22', '2026-07-12 23:11:22', NULL);
...
(238, 1, 'Delete', 'attendance', 1, 'Deleted attendance log #1', '2026-07-12 11:22:35'),
(239, 1, '', 'hrms', 0, 'Filed resignation for jushiramen (EMP-0002) — Last Day: 2026-07-14', '2026-07-12 14:50:17'),
(240, 1, '', 'hrms', 0, 'Resignation #1 for jushiramen marked as Acknowledged', '2026-07-12 14:50:42'),
(241, 1, 'Create', 'attendance', 2, 'Manual attendance entry for employee ID 7 on 2026-07-12', '2026-07-12 15:11:22'),
(242, 1, 'Create', 'applicants', 11, 'Added applicant: Argentina Corn Beef', '2026-07-12 15:20:15'),
(243, 1, 'Update', 'applicants', 11, 'Advanced Argentina Corn Beef to stage: First Interview', '2026-07-12 15:20:20'),
(244, 1, 'Update', 'applicants', 11, 'Advanced Argentina Corn Beef to stage: Final Interview', '2026-07-12 15:20:23'),
(245, 1, 'Update', 'applicants', 11, 'Advanced Argentina Corn Beef to stage: Approved', '2026-07-12 15:20:29'),
(246, 1, 'Create', 'applicants', 12, 'Added applicant: Lucky Me Noodles', '2026-07-12 18:02:36'),
(247, 1, 'Update', 'applicants', 12, 'Advanced Lucky Me Noodles to stage: First Interview', '2026-07-12 18:03:48'),
(248, 1, 'Update', 'applicants', 12, 'Advanced Lucky Me Noodles to stage: Final Interview', '2026-07-12 18:04:22'),
(249, 1, 'Update', 'applicants', 12, 'Advanced Lucky Me Noodles to stage: Approved', '2026-07-12 18:04:47'),
(250, 1, '', 'hrms', 0, 'Filed Sick Leave for jushiramen (2026-07-13 to 2026-07-23, 11 day(s)) — Status: Pending', '2026-07-12 18:21:21'),
(251, 1, '', 'hrms', 0, 'Filed Sick Leave for jushiramen (2026-07-13 to 2026-07-23, 11 day(s)) — Status: Pending', '2026-07-12 18:21:26'),
(252, 1, '', 'hrms', 0, 'Deleted leave #1 (Sick Leave) for jushiramen', '2026-07-12 18:21:34');
...
(10, 6, NULL, 10, 'EMP-0002', 'jushiramen', 'sushiramenthis1@gmail.com', '09123123123', 'BLK 1 LOT 28', '2005-08-14', 'Male', 'Single', '2026-07-12', 'Full-time', 15000.00, 'Active', NULL, '', '', '', '', '2026-07-12 11:21:15', '2026-07-12 19:21:15');
...
INSERT INTO `leave_requests` (`leave_id`, `employee_id`, `leave_type`, `date_from`, `date_to`, `days`, `reason`, `document`, `status`, `approved_by`, `created_at`) VALUES
(2, 10, 'Sick Leave', '2026-07-13', '2026-07-23', 11, 'gvygvyg', '1783880486_LCS_Reviewer_20260711_175344_0000.pdf', 'Pending', NULL, '2026-07-12 18:21:26');
...
(55, 'Job Posting Deleted', 'Position \'Store Clerk\' has been removed from the system.', '', 1, '2026-07-10 10:18:17'),
(56, 'Job Posting Deleted', 'Position \'Store Clerk\' has been removed from the system.', '', 1, '2026-07-10 10:18:34'),
(57, 'Job Posting Deleted', 'Position \'efwqefwef\' has been removed from the system.', '', 1, '2026-07-10 10:18:36'),
(58, 'New Job Posting', 'Position \'Sales Supervisor\' has been created.', '', 1, '2026-07-10 16:18:48');
...
INSERT INTO `payroll` (`payroll_id`, `period_id`, `employee_id`, `basic_salary`, `days_worked`, `hours_per_day`, `overtime_pay`, `gross_pay`, `sss`, `philhealth`, `pagibig`, `withholding_tax`, `other_deductions`, `deduction_notes`, `total_deductions`, `net_pay`, `status`, `created_at`) VALUES
(3, 3, 7, 300000.00, 13.00, 8.00, 3605.77, 153605.77, 900.00, 1250.00, 100.00, 72866.67, 0.00, 'cqccqc', 75116.67, 78489.10, 'Draft', '2026-07-11 15:36:54');
...
INSERT INTO `resignations` (`resignation_id`, `employee_id`, `resignation_type`, `date_filed`, `last_day`, `reason`, `remarks`, `status`, `processed_by`, `processed_at`, `created_by`, `created_at`) VALUES
(1, 10, 'Mutual Agreement', '2026-07-12', '2026-07-14', 'feqfqefqefqf', 'fqqwfwqfwqfqwf', 'Acknowledged', 1, '2026-07-12 16:50:42', 1, '2026-07-12 14:50:17');
...
(16, 'sushiramenthis1@gmail.com', '$2y$10$z1xUIRjYq/vuwcIZ.S/HRe.AqU8QyeXhMFaB8yoV4R8O3Smf/VIj2', 'Sushi', '', 'Active', '2026-07-12 10:29:48', NULL);
