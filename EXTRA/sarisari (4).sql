...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2026 at 09:34 AM
...
(1, 5, 15, 5, 99, '2', '2026-06-26 19:34:46', '2026-06-28 10:12:28'),
(2, 6, 0, 5, 100, NULL, NULL, '2026-06-26 19:20:22'),
(4, 7, 1, 5, 100, '23', '2026-06-26 23:30:34', '2026-06-26 23:30:34'),
(8, 13, 50, 5, 100, 'Aisle 1', NULL, '2026-06-27 23:14:28'),
...
(2, 1, 12.00, 12.00, 0.00, 'Completed', '2026-06-27 10:47:32'),
(3, 1, 2706.00, 5000.00, 2294.00, 'Completed', '2026-06-27 10:48:04'),
(4, 3, 172.00, 200.00, 28.00, 'Completed', '2026-06-28 02:12:28');
...
(1, 'admin1234@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin User', 'Admin', 'Active', '2026-06-25 16:46:12', '2026-06-28 10:14:48'),
(2, 'Johnmmartinez814@Gmail.com', '$2y$10$eR2UcCDuSTcA.47RCBnQte/nK4xdqM9f5eFArHbsEo2YlALBn8lcS', 'John Mark Martinez', 'Customer', 'Active', '2026-06-27 15:38:25', '2026-06-27 23:40:00'),
(3, 'Jmark14@gmail.com', '$2y$10$LqRhmirUz6m33Uz6c5eYe.Q4iqpTOxK8UWBeZwN.TY86cijAM2S9e', 'Jeyem', 'Cashier', 'Active', '2026-06-27 16:33:09', '2026-06-28 10:13:43');
...
ALTER TABLE `cart`
  ...
  ADD KEY `fk_cart_cashier` (`customer_id`);
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `fk_cart_cashier` FOREIGN KEY (`customer_id`) REFERENCES `users` (`user_id`);
